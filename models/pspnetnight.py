...
class PSPNet(nn.Module):
    ...
    def forward(self, x, y=None):
        ...
        if self.training:
            ...
            # CORRECTION ICI : On ne calcule plus la loss en interne (qui causait le crash).
            # On renvoie simplement les tenseurs, et le script d'entraînement s'occupe du reste.
            return x, aux
        else:
            return x
